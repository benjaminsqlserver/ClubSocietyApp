...
using SocietyApp.Authentication;
  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new SocietyApp.Data.XlsDataContractSerializerOutputFormatter());
          ...
          options.OutputFormatters.Add(new SocietyApp.Data.CsvDataContractSerializerOutputFormatter());
      ...
      services.AddAuthorization();
              ...
              oDataBuilder.EntitySet<SocietyApp.Models.ConData.ContributionsView>("ContributionsViews");
              oDataBuilder.EntitySet<SocietyApp.Models.ConData.Gender>("Genders");
              oDataBuilder.EntitySet<SocietyApp.Models.ConData.Member>("Members");
              oDataBuilder.EntitySet<SocietyApp.Models.ConData.MemberContribution>("MemberContributions");

              var memberListProcs = oDataBuilder.Function("MemberListProcsFunc");
              memberListProcs.ReturnsCollectionFromEntitySet<SocietyApp.Models.ConData.MemberListProc>("MemberListProcs");
              oDataBuilder.EntitySet<SocietyApp.Models.ConData.MemberPosition>("MemberPositions");
      ...
      services.AddDbContext<SocietyApp.Data.ConDataContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("ConDataConnection"));
      });
