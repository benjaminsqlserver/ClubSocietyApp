/*
  ...
  Modify edit-gender.component.ts instead.
*/
...
export class EditGenderGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('genderNameLabel') genderNameLabel: LabelComponent;
  @ViewChild('genderName') genderName: TextBoxComponent;
  @ViewChild('genderNameRequiredValidator') genderNameRequiredValidator: RequiredValidatorComponent;
  ...
  load() {
    ...
    this.conData.getGenderByGenderId(null, this.parameters.GenderID)
  ...
  form0Submit(event: any) {
    this.conData.updateGender(null, this.parameters.GenderID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Gender` });
    });
  }
